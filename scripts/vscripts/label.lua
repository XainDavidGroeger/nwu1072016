function GameMode:setPlayerHealthLabel( player )
    if PlayerResource:IsValidPlayerID(player:GetPlayerID()) then
        ...
        --  end
          ...
          --Charmezard
           if PlayerResource:GetSteamAccountID(player:GetPlayerID()) == 166776760 then
            if PlayerResource:GetPlayer(player:GetPlayerID()):GetAssignedHero() ~= nil then
              PlayerResource:GetPlayer(player:GetPlayerID()):GetAssignedHero():SetCustomHealthLabel("RogueNinja", 183, 144, 212)
            end
          end
          --digital
          ...
          if PlayerResource:GetSteamAccountID(player:GetPlayerID()) == 35879484 then
            if PlayerResource:GetPlayer(player:GetPlayerID()):GetAssignedHero() ~= nil then
              PlayerResource:GetPlayer(player:GetPlayerID()):GetAssignedHero():SetCustomHealthLabel("The Eternal Genin", 255, 140, 0)
            end
          end
           --lucci
