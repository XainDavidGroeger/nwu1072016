function summon_katsuyu( keys )
	...
	if (ability:GetLevel() == 1) then
		...
		katsuyu:FindAbilityByName("katsuyu_kuchiyose_no_jutsu"):SetLevel(0)
		katsuyu:FindAbilityByName("katsuyu_physical_composition"):SetLevel(0)
		katsuyu:FindAbilityByName("katsuyu_slug_great_division"):SetLevel(0)
