...
function playSound( keys )
	...
	if random == 1 then
		EmitSoundOn("shikamaru_q",keys.caster)
	elseif random == 2 then
		EmitSoundOn("shikamaru_q_2",keys.caster)
	elseif random == 3 then
		EmitSoundOn("shikamaru_hold_3",keys.caster)
	elseif random == 4 then
		EmitSoundOn("shikamaru_hold_4",keys.caster)
	end
end